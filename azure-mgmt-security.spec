...
Source0  : https://files.pythonhosted.org/packages/97/3b/0836c85edf96157776d92e2875592ce269ddd7fd78cac582116ece885f41/azure-mgmt-security-0.6.0.zip
...
%prep
%setup -q -n azure-mgmt-security-0.6.0
cd %{_builddir}/azure-mgmt-security-0.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047724
